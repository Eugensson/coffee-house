...
export const Header = () => {
  ...
  return (
    <header className="absolute top-[40px] left-0 right-0 z-30">
      <div className="container mx-auto">
        <div className="flex justify-between items-center">
          <Link
            href="/"
            className="relative w-[100px] h-[40px] xl:w-[120px] xl:h-[40px] z-40"
          >
            <Image
              src="/assets/logo.svg"
              alt="logo"
          ...
          <button
            ...
            type="button"
            className="w-8 h-6 text-accent relative flex justify-center items-center z-40 outline-none"
          >
            <span
